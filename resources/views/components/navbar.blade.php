     ...
     <div class="px-5 py-3 lg:px-5 lg:pl-3">
         <div class="flex items-center justify-between sm:px-10">
             <div class="flex items-center justify-start rtl:justify-end">
                 ...
                 @else
                     <a href="/transaksi" class="flex ms-2 md:me-24">
                         <img src="{{ asset('assets/icons/icons-1.png') }}" class="h-12 me-3" alt="FlowBite Logo" />
                         <div class="grid">
                             <span
                                 class="self-center text-xl font-semibold sm:text-xl whitespace-nowrap dark:text-white">Garuda
             ...
             <div class="flex items-center">
                 <div class="flex items-center ms-3">
                     <div>
                         <button type="button"
                             class="flex text-sm transition bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"
                             aria-expanded="false" data-dropdown-toggle="dropdown-user">
                             <span class="sr-only">Open user menu</span>

                             <div
                                 class="relative w-8 h-8 overflow-hidden shadow bg-gray-100 rounded-full dark:bg-gray-600">
