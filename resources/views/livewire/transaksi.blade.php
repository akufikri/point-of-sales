                ...
                <div class="flex">
                    ...
                    <div class="relative w-full">
                        <input type="search" id="search-dropdown"
                            class="block p-2.5 w-full z-20 text-sm transition text-gray-900 bg-gray-50  border-e-gray-50 border-e-2 border border-gray-300 focus:ring-orange-500 focus:border-orange-500 dark:bg-gray-700 dark:border-e-gray-700  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-orange-500"
                    ...
                    <div id="dropdown"
                        class="z-10 hidden bg-white divide-y divide-gray-100 rounded shadow w-80 dark:bg-gray-700 right-0">
                                    ...
                                    <button x-on:click="isDropdownOpen = false; $wire.selectProduk({{ $item->id }})"
                                        ...
                                        <div class="flex items-center gap-4">
                                            <img class="w-10 h-10 rounded-full"
                                                src="{{ asset('img_produk/' . $item->foto_produk) }}" alt="">
    ...
    <div class="relative overflow-x-auto shadow-md border rounded">
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="3" class="text-center text-md  sm:text-2xl font-bold py-10">No products selected
                        </td>
                    </tr>
                @endforelse
            </tbody>
            ...
            <tfoot>
                <tr class="font-semibold text-gray-900 dark:text-white border-t">
                    <th scope="row" class="px-6 py-3 text-base sm:text-2xl text-gray-500">Total : </th>
                    <td class="px-6 py-3 text-base sm:text-xl text-gray-500">{{ $totalQuantity }}</td>
                    <td class="px-6 py-3 text-base sm:text-xl text-gray-500">Rp.{{ number_format($totalPrice, 2) }}</td>
                </tr>
            </tfoot>
        </table>
    </div>
        ...
        <div class="flex flex-wrap sm:flex-nowrap gap-10">
            ...
            <div class="border-l pl-7">
                <div class="flex mt-4 gap-5">
                    <div class="mt-5">
                        <ul>
                            <li class="font-bold text-sm sm:text-2xl mb-7">Fee Admin : </li>
                            <li class="font-bold text-sm sm:text-2xl">Total Fee : </li>
                        </ul>
                    </div>
                    <div>
                        <ul>
                            <li>
                                <div class="relative">
                                    ...
                                    <input wire:model="feeAdmin" type="number" name="" id=""
                                        class="sm:h-8 sm:w-auto w-auto  h-9 mt-1 focus:ring-orange-500 focus:border-orange-500 transition">
                                </div>
                            </li>
                            <li class="mt-7 font-medium sm:text-xl text-base">
